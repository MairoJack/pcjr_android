        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                if(t.getMessage().equals("登陆过期")){
                    Toast.makeText(BindMobileActivity.this, "登陆过期,请重新登陆", Toast.LENGTH_SHORT).show();
                    finish();
                    startActivityForResult(new Intent(BindMobileActivity.this, LoginActivity.class),Constant.REQUSET);
                }else {
