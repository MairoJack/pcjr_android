 ...
 */
public class ICUnusedFragment extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        View emptyView = View.inflate(getContext(),R.layout.no_records,null);
